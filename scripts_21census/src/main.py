...
from scripts_21census.synthesizer import IPF, SA
from src.basics import Constraints
from src.cases import simple_random_case, get_census_2021_base_population
import time
import pandas as pd
import geopandas as gpd
from src.functional_segments import get_new_pop, random_point_in_shp, aggregate_dict, IPF_Matrix
from src.get_marginal_distribution import marg_age_dist, marg_sex_dist,marg_ethnic_dist,marg_car_dist,marg_os_freq_dist
...
def inner_london_prediction():
    ...
    base_pop = get_census_2021_base_population(inner_london_microdata_file, simplified=True)
